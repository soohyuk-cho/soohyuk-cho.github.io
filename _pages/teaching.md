...
<details markdown="1">
  <summary><em>TA/UCS2: CS 189 (Introduction to Machine Learning) Spring 2025</em></summary>
I served as a 20-hr TA for CS 189 (Introduction to Machine Learning) Spring 2025. I supported a cohort of **720+ students** and served as the lead TA for exams and student support.
  
My responsibilities included:
- Holding weekly office hours
- Leading content writing for homework and discussion questions
- Teaching discussion sections
- Leading exam planning and logistics (blueprints, reviews, scheduling, proctoring, regrade workflows)
- Coordinating student support operations (office-hours coverage, extensions/accommodations, high-volume help channels)
- Partnering with the instructional team on policies and course operations

**Materials:** [Discussion mini-lecture notes and slides (Spring 2025)](https://drive.google.com/drive/folders/1sjsJ31B_fa6DLmhSXTq1ahhtxSkuCQF1?usp=drive_link)
</details>

<details markdown="1">
  <summary><em>TA/UCS2: EE 120 (Signals and Systems) Fall 2024, Spring 2023</em></summary>
I served as a 10-hr TA (Fall 2024) and a 8-hr TA for EE 120 (Signals and Systems), supporting **120+ students per semester**. 
  
My responsibilities included:
- Holding weekly office hours
- Writing problems for homework, discussion, and exams
- Teaching discussion sections
- Managing and updating the course website

**Materials:** [Discussion mini-lecture notes (Fall 2024)](https://drive.google.com/drive/folders/12CqJeZ8DiSTzMhOwjuNWAwjwd5eZwrDo?usp=sharing)
</details>
